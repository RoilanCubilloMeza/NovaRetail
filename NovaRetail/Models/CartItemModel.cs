...
namespace NovaRetail.Models
{
    public class CartItemModel : INotifyPropertyChanged
    {
        ...
        public string UnitPriceColonesText => $"{UiConfig.CurrencySymbol}{Math.Round(EffectivePriceColones, 2, MidpointRounding.AwayFromZero):N2}";
        public string OriginalPriceColonesText => $"{UiConfig.CurrencySymbol}{Math.Round(UnitPriceColones, 2, MidpointRounding.AwayFromZero):N2}";
        public string TotalColonesText => $"{UiConfig.CurrencySymbol}{Math.Round(EffectivePriceColones * Quantity * DiscountFactor, 2, MidpointRounding.AwayFromZero):N2}";
